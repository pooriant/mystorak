...
/*
  private void displayDatabaseInfo() {
    ...
    //we must delete this line beacuse we dont want to get acsess to db from calalog activity    //
...
// we delete this line too beacuse we dont want accsess to db from this activigy   //
    Cursor cursor = db.query(ItemsContract.ItemsEntry.TABLE_NAME_ITEMS,Projection, null, null, null, null, null);
    ...
    try {
      ...
      textView.append(ItemsContract.ItemsEntry._ID + " - "
      + ItemsContract.ItemsEntry.COLUMN_NAME+" - "
      + ItemsContract.ItemsEntry.COLUMN_DESCRIPTION+ " - "
      + ItemsContract.ItemsEntry.COLUMN_PRICE + " - "
      + ItemsContract.ItemsEntry.COLUMN_QUANTITY + " - "
    ...
    int nameColumnIndex = cursor.getColumnIndex(ItemsContract.ItemsEntry.COLUMN_NAME);
    int discriptionColumnIndex = cursor.getColumnIndex(ItemsContract.ItemsEntry.COLUMN_DESCRIPTION);
    ...
    int supplierColumnIndex = cursor.getColumnIndex(ItemsContract.ItemsEntry.COLUMN_SUPPLIER);
    ...
    while (cursor.moveToNext()) {
      ...
      String discription = cursor.getString(discriptionColumnIndex);
